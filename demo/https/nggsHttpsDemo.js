define([
  ...
  function () {
    ...
    function nggsHttpsDemoController(nggsHttpsDemoFactory, nggsHttpsFactory, $anchorScroll) {
      ...
      nggsHttpsDemoFactory.get({
        pagina: 1,
        tamanho: 10
      }, { httpConfig: 'lalala', headers: ['lalala'] });
      // nggsHttpsDemoFactory.post({
      //   cod: 1
      // }, {
      //   data: 'pacote'
      // }, {
      //   query: 'lalala'
      // });
      // nggsHttpsFactory.resolveHttps('get', 'api/test', {
      //   pagina: 1
      // });
      // nggsHttpsFactory.resolveHttps('post', 'api/test/:pagina', {
      //   pagina: 1
      // }, {
      //   tamanho: 10
      // });
